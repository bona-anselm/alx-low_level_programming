/**
 * palindromeChecker - checks is a string is a palindrome
 * @str: Holds data for the string to be checked
 * @len: Holds data for the length of the string
 * @i: iterator, starts at 0
 *
